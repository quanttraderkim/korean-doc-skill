...
문제의식은 단순합니다. AI가 한국어 업무 문서를 만들면 대체로 말이 많고, `~입니다 / ~합니다`가 반복되고, 추상 수식어가 많아지고, 줄글이 길어집니다. 이 킷은 그 반대로 밀어줍니다. 결론 우선, 짧은 판단형 문장, 의미가 있는 제목, 필요한 곳에만 불릿과 표, 긴 문서에서는 `A. / A-1.` 넘버링을 쓰는 방향입니다.
